...
using AutoMapper;
using FsegaManagement.Configs;
using FsegaManagement.Interfaces;
using FsegaManagement.Repos;
...
builder.Services.AddDefaultIdentity<Angajat>(options => options.SignIn.RequireConfirmedAccount = false)
